            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-5xl sm:w-full">
                            ...
                            <div x-show="tab === 'preview'" class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select id="criterioSelector" wire:model.live="criterioSeleccionadoId"
                                        ...
                                        {{ $columnaAsignadaPorcentajes ? 'disabled' : '' }}>
                                        <option value="">Seleccione una columna...</option>
                                        @foreach($criterios ?? [] as $criterio)
                                            <option value="{{ $criterio['id'] }}" {{ in_array($criterio['id'], $columnasConPorcentajes ?? []) ? 'class="bg-green-100"' : '' }}>
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button type="button" wire:click="aplicarPorcentajesAsistencia"
                            ...
                            {{ $columnaAsignadaPorcentajes || !$criterioSeleccionadoId ? 'disabled' : '' }}>
